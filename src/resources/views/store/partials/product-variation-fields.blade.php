                                                ...
                                                @if($variation->type === 'label_type')
                                                    <div class="label-type-suboptions-wrap mt-4 pt-3 border-t border-slate-100 hidden">
                                                        ...
                                                        <div class="label-type-custom-print-artwork-section hidden mb-4">
                                                            <p class="text-sm font-semibold text-slate-800 mb-2">{{ __('store.product.label_custom_print_artwork_question') }}</p>
                                                            <div class="flex flex-wrap gap-2.5">
                                                                <button type="button" class="label-type-custom-print-artwork-btn px-4 py-2.5 rounded-xl border border-slate-300 text-sm font-medium text-slate-700 hover:bg-slate-50 min-h-[2.75rem]" data-artwork="customer_send">{{ __('store.product.label_custom_print_artwork_customer') }}</button>
                                                                <button type="button" class="label-type-custom-print-artwork-btn px-4 py-2.5 rounded-xl border border-slate-300 text-sm font-medium text-slate-700 hover:bg-slate-50 min-h-[2.75rem]" data-artwork="company_prepare">{{ __('store.product.label_custom_print_artwork_company') }}</button>
                                                            </div>
                                                        </div>
                                                        <div class="label-type-position-section hidden mb-4">
                                                            <p class="text-sm font-semibold text-slate-800 mb-2">{{ __('store.product.label_position_pick') }}</p>
                                                            <div class="flex flex-wrap gap-2.5">
